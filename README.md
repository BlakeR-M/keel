...
step is skipped once it has already happened, so a second run just starts the server. Add `--empty`
to skip the fixture corpus and start with a store holding only what you put in it.
